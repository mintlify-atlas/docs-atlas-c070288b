---
title: "OwnPay Financial Reports — Payment Analytics Guide"
sidebarTitle: "Reports"
description: "Filter, generate, and export financial reports with revenue totals, transaction counts, average values, and gateway fees per brand in OwnPay."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Export to CSV" icon="file-csv" href="/user-guide/reports-finance/reports#exporting-reports-to-csv">
