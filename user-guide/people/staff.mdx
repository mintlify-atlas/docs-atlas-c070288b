---
title: "Staff Accounts — Invite, Assign Roles, and Set Permissions"
sidebarTitle: "Staff"
description: "Create staff accounts, assign roles and brand access, configure individual permissions, and manage team members in the OwnPay admin panel."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Suspend to revoke access" icon="user-slash" href="/user-guide/people/staff#deactivating-a-staff-account">
