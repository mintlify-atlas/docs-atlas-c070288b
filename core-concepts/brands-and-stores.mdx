---
title: "Brands and Stores in OwnPay"
...
<Tabs>
  ...
  <Tab title="Branding">
    ...
    | **Primary Color** | Hex color for buttons and accents on the checkout UI |
    | **Custom CSS** | Raw CSS injected into the checkout page for advanced styling |
  ...
  <Tab title="Checkout">
    ...
    | **Redirect URL** | Default URL to redirect customers to after checkout completion |
  </Tab>
  <Tab title="Advanced">
    | Field | Description |
    |-------|-------------|
...
<Steps>
  ...
  <Step title="Apply Custom CSS (Optional)">
    For pixel-level control over the checkout appearance, add custom CSS in **Settings → Branding → Custom CSS**. This is injected directly into the checkout page.
  </Step>
</Steps>
